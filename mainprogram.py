# this is not main program , run PRSYSTEM
...
# myarray = face_recognition.face_locations(image)
# print(len(str(face_recognition.face_locations(image))))
# print(str(face_recognition.face_locations(image)))
...
# #
# #
mycursor.execute("select FACE_ENCODING from persons_data_table where ID = '175'")
result = mycursor.fetchall()
for row in result:
